...
#일반 부스터 파티클
execute if score @s kartboosttime matches 36.. unless score @s kartboosttime matches 32..40 on passengers rotated as @s[tag=kartdirectiontemp,type=marker] rotated ~ 0 run particle minecraft:enchanted_hit ^ ^1 ^1 .25 .25 .25 1.25 1 normal @a[tag=kart-listener]
