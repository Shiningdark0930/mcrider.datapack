...
#1.0엔진 - 낮은 피치각 물리
execute if score @s kartmove matches 1000.. if score @s kart-engine matches 7 if score @s kartaccel matches 0.. on passengers as @s[tag=kartdirectiontemp,type=marker] at @s anchored eyes rotated as @p[tag=kartpassenger,distance=..0.3] rotated ~ 23.5 positioned ^ ^ ^5 rotated as @s run function kartmobil:move/steer/drift-physics/driftmacro with storage kartmain
#다른 엔진
execute if score @s kartmove matches 1000.. unless score @s kart-engine matches 7 if score @s kartaccel matches 0.. on passengers as @s[tag=kartdirectiontemp,type=marker] at @s anchored eyes rotated as @p[tag=kartpassenger,distance=..0.3] rotated ~ 35 positioned ^ ^ ^5 rotated as @s run function kartmobil:move/steer/drift-physics/driftmacro with storage kartmain
execute if score @s kartmove matches 1000.. if score @s kartaccel matches ..-1 on passengers as @s[tag=kartdirectiontemp,type=marker] at @s anchored eyes rotated as @p[tag=kartpassenger,distance=..0.3] rotated ~180 35 positioned ^ ^ ^5 rotated as @s run function kartmobil:move/steer/drift-physics/driftmacro-back with storage kartmain
execute if score @s kartmove matches ..999 on passengers as @s[tag=kartdirectiontemp,type=marker] run function kartmobil:move/steer/drift-physics/driftmacro-lowspeed   
