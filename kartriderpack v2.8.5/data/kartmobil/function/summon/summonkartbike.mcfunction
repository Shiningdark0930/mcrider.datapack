...
#카트 엔티티들 소환
summon item_display ~ ~ ~ {Tags:["kartmodelsaddle","karttemp","kartentity"]}
summon item_display ~ ~ ~ {teleport_duration:2,Tags:["kartmobil","kartbike","karttemp"]}

summon marker ~ ~ ~ {Tags:["kartdatacarrier","kartentity","karttemp"]}
summon marker ~ ~ ~ {Tags:["kartdirection","kartentity","karttemp"]}
summon marker ~ ~ ~ {Tags:["kart-old-velocity","kartentity","karttemp"]}

summon armadillo ~ ~ ~ {NoAI:1b,Silent:1b,Invulnerable:1b,NoGravity:1b,Tags:["kartentity","kartsaddle","karttemp"],DeathLootTable:"minecraft:empty"}
