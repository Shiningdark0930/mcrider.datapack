...
summon item_display ~ ~ ~ {teleport_duration:2,Tags:["kartmobil","karttemp","kartentity"]}
...
summon cod ~ ~ ~ {NoAI:1b,Silent:1b,Invulnerable:1b,NoGravity:1b,Tags:["kartentity","kartsaddle","karttemp"],DeathLootTable:"minecraft:empty"}
