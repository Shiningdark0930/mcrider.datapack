...
data modify storage kartactbar message append value [{"keybind":"key.left","color":"aqua","bold":false},{"text":" or ","color":"yellow","bold":false},{"keybind":"key.right","color":"aqua","bold":false},{"text":" ","color":"yellow","bold":false}]
...
function kartmobil:control/boost-gauge/gear-leftgauge
...
function kartmobil:control/boost-gauge/gear-rightgauge

data modify storage kartactbar message append value [{"text":" ","color":"yellow","bold":false},{"text":"GEAR ","color":"yellow","bold":false}]
execute if score @s kartboostcount matches 1..5 run data modify storage kartactbar message append value [{"score":{"name":"@s","objective":"kartboostcount"},"color":"aqua","bold":false},{"text":"단","color":"yellow","bold":false}]
execute if score @s kartboostcount matches 6 run data modify storage kartactbar message append value [{"score":{"name":"@s","objective":"kartboostcount"},"color":"red","bold":false},{"text":"단","color":"yellow","bold":false}]
