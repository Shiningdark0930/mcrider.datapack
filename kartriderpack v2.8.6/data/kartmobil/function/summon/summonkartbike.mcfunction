...
summon item_display ~ ~ ~ {Tags:["kartmobil","karttemp","kartbike"],teleport_duration:2}

summon marker ~ ~ ~ {Tags:["kartdatacarrier","kartentity","karttemp"]}
summon marker ~ ~ ~ {Tags:["kart-old-velocity","kartentity","karttemp"]}

summon armadillo ~ ~ ~ {Tags:["kartentity","kartsaddle","karttemp"],CustomName:"mcrider-saddle-common",NoAI:1b,Silent:1b,Invulnerable:1b,NoGravity:1b,DeathLootTable:"minecraft:empty"}
