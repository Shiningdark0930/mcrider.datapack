...
execute as @n[tag=kartmobil,tag=karttemp,type=item_display] if score @s kart-engine matches 1004 run data merge entity @n[tag=kartsaddle] {CustomName:"mcrider-saddle-boat"}
