...
execute if score #kartspeed kartmove matches 5.. run playsound minecraft:block.barrel.open neutral @a[tag=kart-listener] ~ ~ ~ 0.15 0.5
...
execute if score #kartspeed kartmove matches 19.. at @a[tag=kartpassenger] run playsound minecraft:block.barrel.open neutral @a[tag=kart-listener] ~ ~ ~ 0.15 0.6 0.5
...
execute if score #kartspeed kartmove matches 52.. at @a[tag=kartpassenger] run playsound minecraft:block.barrel.open neutral @a[tag=kart-listener] ~ ~ ~ 0.15 0.8 0.5
...
execute if score #kartspeed kartmove matches 32.. run function kartmobil:soundandfov/new/soundmacro with storage kartmain
