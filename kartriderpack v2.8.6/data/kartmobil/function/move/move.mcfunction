...
execute if score @s[tag=!kart-stop] kartmove-remain matches 1000.. at @s on passengers rotated as @s[tag=kartdirectiontemp,type=item_display] on vehicle rotated ~ 0 run function kartmobil:move/movetp/moveforward
