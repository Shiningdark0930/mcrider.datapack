...
execute on passengers as @s[tag=kartdatacarrier,type=marker] store result entity @s Rotation[0] float 0.1 run scoreboard players get #kartplayerangle kartmain
...
execute on passengers as @s[tag=kartdatacarrier,type=marker] rotated as @s on vehicle on passengers as @s[tag=kartmodelsaddle,type=item_display] run rotate @s ~ 0
execute on passengers as @s[tag=kartdatacarrier,type=marker] rotated as @s on vehicle on passengers run rotate @s[tag=kartsaddle,type=#kartmobil:modeldir] ~ 0

#execute on passengers rotated as @n[distance=..0.00001,tag=kartdatacarrier,type=marker] run tp @s ~ ~ ~ ~ 0
