...
# v1 = 0.125v1 + 0.875v2
execute store result storage minecraft:kartmain kart-collision-1 int 0.125 run scoreboard players get #kart-speed-a kartmove
execute store result storage minecraft:kartmain kart-collision-2 int 0.875 run scoreboard players get #kart-speed-b kartmove
...
# v2 = 0.875v1 + 0.125v2
execute store result storage minecraft:kartmain kart-collision-1 int 0.875 run scoreboard players get #kart-speed-a kartmove
execute store result storage minecraft:kartmain kart-collision-2 int 0.125 run scoreboard players get #kart-speed-b kartmove
