...
#부스터 패드 탈 때
execute if score @s kartboostpadtime matches 1.. on passengers rotated as @s[tag=kartdirectiontemp,type=item_display] rotated ~ 0 run particle minecraft:soul_fire_flame ^ ^1 ^1 .75 .75 .75 0 3 force @a[tag=kart-listener]
