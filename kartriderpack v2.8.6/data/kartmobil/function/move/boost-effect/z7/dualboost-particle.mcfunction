...
execute rotated as @n[distance=..0.00001,tag=kartdirectiontemp,type=item_display] rotated ~ 0 run particle minecraft:flash ^ ^1 ^2 0 0 0 1 1 force @a[tag=kart-listener]
execute rotated as @n[distance=..0.00001,tag=kartdirectiontemp,type=item_display] rotated ~ 0 run particle minecraft:enchanted_hit ^ ^1 ^1 .25 .25 .25 2 50 force @a[tag=kart-listener]
