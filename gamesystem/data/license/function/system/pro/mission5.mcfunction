...
#11초(220) 안에 완주
bossbar set minecraft:license max 74750

bossbar set minecraft:license name {"text":"01:14.750 내로 완주","color":"aqua"}

execute store result bossbar minecraft:license value run scoreboard players get time timermain

execute if score time timermain matches 74751.. run function license:system/retirefail
#완주 못하면 리타이어
...
execute if score @s timelap >= #maxlap timelap run function license:system/pro/mission5complete
